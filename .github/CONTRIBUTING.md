# Contributing to DictateKit

Thanks for your interest in contributing. DictateKit is an open-source,
...
4. Open a pull request against `DictateKit/dictatekit` `main` and fill
...
improvement helps make DictateKit better.
