...
inputs.dictatekit.url = "github:DictateKit/dictatekit";

# in your NixOS modules
imports = [ dictatekit.nixosModules.default ];
programs.dictatekit = {
  enable = true;
  users = [ "<you>" ];
};`;
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          {t("settingsPage.general.waylandPaste.nixos.flakeDesc", {
            defaultValue:
              "If you install DictateKit from the flake, programs.dictatekit.enable turns on ydotool, the uinput module and the group memberships for you.",
          })}
        </p>
