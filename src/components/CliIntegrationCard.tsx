...
const INSTALL_CMD = "npm install -g @dictatekit/cli";
const LOCAL_EXAMPLE = "dictatekit --local notes list";
const CLOUD_LOGIN_CMD = "dictatekit auth login";
  ...
  return (
    <div className="rounded-lg border border-border/50 dark:border-border-subtle/70 bg-card/50 dark:bg-surface-2/50 backdrop-blur-sm p-4">
      <div className="flex items-center gap-2 mb-4">
        <LogoTile src={logo} alt="DictateKit" />
