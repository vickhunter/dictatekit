...
> = {
  ...
  corti: {
    consoleUrl: "https://www.corti.ai/?utm_source=referral&utm_content=&utm_campaign=dictatekit",
    fields: [
  ...
  tinfoil: {
    consoleUrl: "https://tinfoil.sh/inference?utm_source=referral&utm_campaign=dictatekit",
...
export default function TranscriptionModelPicker({
  ...
  useEffect(() => {
    ...
    window.addEventListener("dictatekit-models-cleared", handleModelsCleared);
    return () => window.removeEventListener("dictatekit-models-cleared", handleModelsCleared);
