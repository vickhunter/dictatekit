...
const SLOT_CONFIG = {
  dictation: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/dictatekit/",
    name: "DictateKit Toggle",
  },
  agent: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/dictatekit-agent/",
    name: "DictateKit Agent",
  },
  meeting: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/dictatekit-meeting/",
    name: "DictateKit Meeting",
  },
  voiceAgent: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/dictatekit-voice-agent/",
    name: "DictateKit Voice Agent",
  },
  translation: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/dictatekit-translation/",
    name: "DictateKit Translation",
  },
};
