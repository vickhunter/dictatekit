...
const DEFAULT_OPENAI_BASE = computeBaseUrl(
  [env.DICTATEKIT_OPENAI_BASE_URL as string | undefined, env.OPENAI_BASE_URL as string | undefined],
  "https://api.openai.com/v1"
);

const DEFAULT_TRANSCRIPTION_BASE = computeBaseUrl(
  [
    env.DICTATEKIT_TRANSCRIPTION_BASE_URL as string | undefined,
...
// DictateKit Cloud API
export const DICTATEKIT_API_URL = (env.VITE_DICTATEKIT_API_URL as string) || "";
