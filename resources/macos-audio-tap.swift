...
final class AudioTapCapture {
    ...
    private let ioQueue = DispatchQueue(label: "com.dictatekit.audio-tap")
    ...
    func start() throws {
        ...
        tapDescription.name = "dictatekit-audio-tap"
    ...
    private func createAggregateDevice(tapUID: String) throws {
        let description: [String: Any] = [
            kAudioAggregateDeviceNameKey: "DictateKit Audio Tap",
            kAudioAggregateDeviceUIDKey: "com.dictatekit.audio-tap.\(UUID().uuidString)",
...
func makeError(
    ...
    return NSError(domain: "DictateKitAudioTap", code: Int(status ?? -1), userInfo: userInfo)
}
