...
!define SHERPA_FIREWALL_RULE "DictateKit Local Transcription Server (sherpa-onnx)"
...
!macro customUnInstall
  ${ifNot} ${isUpdated}
    nsExec::ExecToLog 'netsh advfirewall firewall delete rule name="${SHERPA_FIREWALL_RULE}"'
    StrCpy $0 "$PROFILE\.cache\dictatekit\models"
    IfFileExists "$0\*.*" 0 +3
      RMDir /r "$0"
      DetailPrint "Removed DictateKit cached models"
    StrCpy $1 "$PROFILE\.cache\dictatekit"
    RMDir "$1"
  ${endIf}
!macroend
