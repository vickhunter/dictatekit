...
let
  ...
  src = fetchurl {
    url = "https://github.com/OpenWhispr/openwhispr/releases/download/v${version}/DictateKit-${version}-linux-x86_64.AppImage";
...
appimageTools.wrapType2 {
  ...
  extraInstallCommands = ''
    install -Dm444 ${appimageContents}/dictatekit.desktop \
